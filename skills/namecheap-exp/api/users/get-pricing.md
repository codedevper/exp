...
- **ProductType** (String, max 20, required): Product Type to get pricing information
- **ProductCategory** (String, max 20, optional): Specific category within a product type
- **PromotionCode** (String, max 20, optional): Promotional (coupon) code for the user
- **ActionName** (String, max 20, optional): Specific action within a product type
- **ProductName** (String, max 20, optional): The name of the product within a product type
