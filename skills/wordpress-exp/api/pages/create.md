...
Create a new page. The request requires authentication and the edit_pages capability.
...
| status | string | A named status for the page. Default: draft |
...
```json
{
  ...
  "content": { "rendered": "<p>This is the about page content.</p>", "protected": false },
  "author": 1,
  "featured_media": 0,
...
| rest_forbidden | You do not have permission to create pages (403) |
