...
Delete an existing post. The request requires authentication and the delete_posts capability for the target post.
...
| status | string | A named status for the post (trash after soft delete) |
...
| rest_forbidden | You do not have permission to delete this post (403) |
| rest_invalid_param | Invalid parameter (400) |
| rest_trash_failed | The post could not be trashed (500) |
