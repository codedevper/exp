## Retrieve an Autosave
GET /wp/v2/autosaves/<parent>/<id>

Retrieve a single autosave by its parent post ID and autosave ID.

## Example Request
```bash
curl -X GET https://example.com/wp-json/wp/v2/autosaves/42/50 \
...
| id | integer | **Required.** The ID of the autosave to retrieve. |
...
| rest_forbidden | You do not have permission to view this autosave. |
