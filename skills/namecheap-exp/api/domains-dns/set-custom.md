...
> Services like URL forwarding, Email forwarding, Dynamic DNS will not work for domains using custom nameservers
...
- **Nameservers** (String, max 1200, required): A comma-separated list of name servers to be associated with this domain
...
- **Updated**: Indicates whether the custom nameservers were set successfully.
