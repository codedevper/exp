...
```bash
curl -X PUT https://example.com/wp-json/wp/v2/settings \
  -H "Content-Type: application/json" \
  -d '{
    "title": "My New Site Title",
    "description": "A better tagline",
    "posts_per_page": 20
  }'
```
...
Any of the settings fields listed below may be provided in the request body.
...
| Code | Description |
|------|-------------|
| rest_forbidden | The user does not have permission to update settings. |
